...
public class MainPage {
	...
	private void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel<>(new String[]{"Mumbai", "Jaipur", "Ahmedabad", "Delhi","Kolkata","Chennai","Banglore","Hyderabad","Pune"}));
		comboBox.setBounds(125, 70, 98, 22);
		frame.getContentPane().add(comboBox);

		JComboBox<String> comboBox_1 = new JComboBox<>();
		comboBox_1.setModel(new DefaultComboBoxModel<>(new String[]{"Mumbai", "Jaipur", "Ahmedabad", "Delhi","Kolkata","Chennai","Banglore","Hyderabad","Pune"}));
		...
		comboBox_3.setModel(new DefaultComboBoxModel<>(new String[]{"Monday", "Tuesday", "Wednesday","Thursday","Friday","Saturday","Sunday"}));
